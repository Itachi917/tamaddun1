export const translations = {
  en: {
    ...
    electricity: {
      ...
      stats: { load: "Grid Load", renewable: "Renewable %", stability: "Stability Score", loss: "Loss Rate" },
  ...
  ar: {
    ...
    electricity: {
      ...
      stats: { load: "حمل الشبكة", renewable: "الطاقة المتجددة", stability: "درجة الاستقرار", loss: "معدل الفقد" },
